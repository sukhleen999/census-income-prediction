...
```{r class-imbalance-distributions, echo=FALSE,  fig.cap="Figure 1.3 Class imbalance and uneven distribution of the training data predictors", out.width = '50%' }
...
```{r country-distributions, echo=FALSE, fig.cap="Figure 1.7 Distribution of income based on country(USA vs others).", out.width = '50%'}
