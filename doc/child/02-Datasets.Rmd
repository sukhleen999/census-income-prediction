...
knitr::kable(train_head, caption = "Table 1.1 Displaying the first 5 rows of the training dataset")
...
knitr::kable(train_info, caption = "Table 1.2 to display information about the datatypes and to check for any missing values")
...
```{r class-imbalance-distributions, echo=FALSE, fig.cap="Figure 1.3 Class imbalance and uneven distribution of the training data predictors", out.width = '100%' }
...
```{r numerical-feature-distributions, echo=FALSE, fig.cap="Figure 1.4 Distribution of numerical features.", out.width = '100%'}
...
```{r statistical-summary, echo=FALSE, fig.cap="Figure 1.5 Statistical summary of numerical features.", out.width = '100%'}
...
```{r categorical-feature-distributions, echo=FALSE, fig.cap="Figure 1.6  Distribution of categorical features", out.width = '100%'}
...
```{r country-distributions, echo=FALSE, fig.cap="Figure 1.7 Distribution of income based on country(USA vs others).", out.width = '100%'}
